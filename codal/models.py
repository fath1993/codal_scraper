...
class CompanyProfile(models.Model):
    ...
    monthly_report_1_date = jmodel.jDateField(null=True, blank=True, editable=False, verbose_name="تاریخ آخرین گزارش ماهانه موجود")
    monthly_report_2_date = jmodel.jDateField(null=True, blank=True, editable=False, verbose_name="تاریخ گزارش ماهانه یکی مانده به آخر")
    monthly_report_3_date = jmodel.jDateField(null=True, blank=True, editable=False, verbose_name="تاریخ گزارش ماهانه دوتا مانده به آخر")
    monthly_report_comparison_1_4 = models.FloatField(null=True, blank=True, editable=False, verbose_name="مقایسه آخرین گزارش ماهانه موجود")
    monthly_report_comparison_2_5 = models.FloatField(null=True, blank=True, editable=False,  verbose_name="مقایسه گزارش ماهانه یکی مانده به آخر")
    monthly_report_comparison_3_6 = models.FloatField(null=True, blank=True, editable=False, verbose_name="مقایسه گزارش ماهانه دوتا مانده به آخر")
    seasonal_report_spring_date = jmodel.jDateField(null=True, blank=True, editable=False, verbose_name="تاریخ گزارش فصلی بهار")
    seasonal_report_spring_date_order = models.SmallIntegerField(null=True, blank=True, editable=False, default=1)
    seasonal_report_spring_percentage = models.FloatField(null=True, blank=True, editable=False, verbose_name="درصد گزارش فصلی بهار")
    seasonal_report_spring_color = models.CharField(max_length=255, null=True, blank=True, editable=False, verbose_name="رنگ گزارش فصلی بهار")
    seasonal_report_summer_date = jmodel.jDateField(null=True, blank=True, editable=False,  verbose_name="تاریخ گزارش فصلی تابستان")
    seasonal_report_summer_date_order = models.SmallIntegerField(null=True, blank=True, editable=False, default=2)
    seasonal_report_summer_percentage = models.FloatField(null=True, blank=True, editable=False, verbose_name="درصد گزارش فصلی تابستان")
    seasonal_report_summer_color = models.CharField(max_length=255, null=True, blank=True, editable=False,  verbose_name="رنگ گزارش فصلی تابستان")
    seasonal_report_fall_date = jmodel.jDateField(null=True, blank=True, editable=False,  verbose_name="تاریخ گزارش فصلی پاییز")
    seasonal_report_fall_date_order = models.SmallIntegerField(null=True, blank=True, editable=False, default=3)
    seasonal_report_fall_percentage = models.FloatField(null=True, blank=True, editable=False, verbose_name="درصد گزارش فصلی پاییز")
    seasonal_report_fall_color = models.CharField(max_length=255, null=True, blank=True, editable=False, verbose_name="رنگ گزارش فصلی پاییز")
    seasonal_report_winter_date = jmodel.jDateField(null=True, blank=True, editable=False, verbose_name="تاریخ گزارش فصلی زمستان")
    seasonal_report_winter_date_order = models.SmallIntegerField(null=True, blank=True, editable=False, default=4)
    seasonal_report_winter_percentage = models.FloatField(null=True, blank=True, editable=False, verbose_name="درصد گزارش فصلی زمستان")
    seasonal_report_winter_color = models.CharField(max_length=255, null=True, blank=True, editable=False, verbose_name="رنگ گزارش فصلی زمستان")
...
class MonthlyReport(models.Model):
    ...
    month_reported_date = jmodel.jDateField(null=False, blank=False, verbose_name="گزارش فعالیت ماهانه دوره ۱ ماهه منتهی به تاریخ")
    report_has_sent_at = jmodel.jDateTimeField(null=False, blank=False, verbose_name="تاریخ و زمان ارسال گزارش توسط کدال")
    created_at = jmodel.jDateTimeField(auto_now_add=True, verbose_name="تاریخ و زمان ایجاد")
    updated_at = jmodel.jDateTimeField(auto_now=True, verbose_name="تاریخ و زمان بروزرسانی")
...
class SeasonalReport(models.Model):
    ...
    operating_ratio = models.FloatField(max_length=255, null=True, blank=True, verbose_name="تقسیم درآمد های عملیاتی بر سود یا زیان ناخالص")
